...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        mean=[0.07171182, 0.07171182, 0.07171182],
        std=[0.13581283, 0.13550861, 0.1352727],
        bgr_to_rgb=False,
        pad_size_divisor=1)
)
...
data_root = '/scratch/yang.zhiyu/tif_test/dlog_data/'
metainfo = {
...
work_dir="/scratch/yang.zhiyu/tif_test/ff_dino_dlog_1112"
