...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        mean=[0.0477841,  0.05742866, 0.03937065],
        std=[0.12443562, 0.13815232, 0.10479768],
        bgr_to_rgb=False,
        pad_size_divisor=1)
)
...
data_root = '/scratch/yang.zhiyu/tif_test/lms_data/'
metainfo = {
...
work_dir="/scratch/yang.zhiyu/tif_test/ff_dino_lms_1112"
