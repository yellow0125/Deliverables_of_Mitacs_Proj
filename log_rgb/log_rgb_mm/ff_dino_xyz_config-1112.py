...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        mean=[0.0443629,  0.05161966, 0.03950519],
        std=[0.11786047, 0.1311462,  0.10536411],
        bgr_to_rgb=False,
        pad_size_divisor=1)
)
...
data_root = '/scratch/yang.zhiyu/tif_test/xyz_data/'
metainfo = {
...
work_dir="/scratch/yang.zhiyu/tif_test/ff_dino_xyz_1112"
